namespace DAL.Migrations
{
    ...
    public partial class Step4Customers : DbMigration
    {
        public override void Up()
        {
            ...
            /*!!!!!!!!!!! Data from International Widgets !!!!!!!!!!!*/

            this.Sql(@"SET IDENTITY_INSERT tbl_customers ON
            ...
            this.Sql(@"update tbl_orders
                set cln_customer_id=56
                where cln_order_id=111");

            this.Sql(@"update tbl_orders
                set cln_customer_id=2
                where cln_order_id=222");
